...
- 周进展记录：`prepare/2026/01_weekly_progress.md`
- 对话同步模板：`prepare/2026/02_chat_sync_template.md`
- 模拟/真实面试复盘：`prepare/2026/03_interview_log.md`
- 每日执行清单：`prepare/2026/04_xiaomi_java_data_service_1month_plan.md`
